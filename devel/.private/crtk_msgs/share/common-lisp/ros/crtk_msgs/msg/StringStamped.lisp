...
(cl:defmethod cl:initialize-instance :after ((m <StringStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crtk_msgs-msg:<StringStamped> is deprecated: use crtk_msgs-msg:StringStamped instead.")))
...
(cl:defmethod string-val ((m <StringStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crtk_msgs-msg:string-val is deprecated.  Use crtk_msgs-msg:string instead.")
  (string m))
